...
#define FMKIO_CONFIGPRIVATE_H_INCLUDED
    ...
    const t_sFMKIO_AnaAdcCfg c_InAnaSigBspMap_as[FMKIO_INPUT_SIGANA_NB] = {
        {{FMKIO_GPIO_PORT_C            , FMKIO_GPIO_PIN_0},  FMKCDA_ADC_1, FMKCDA_ADC_1_CHANNEL_10},    // FMKIO_INPUT_SIGANA_1
        {{FMKIO_GPIO_PORT_C            , FMKIO_GPIO_PIN_0},  FMKCDA_ADC_1, FMKCDA_ADC_1_CHANNEL_10},  // FMKIO_INPUT_SIGANA_3
        {{FMKIO_GPIO_PORT_C            , FMKIO_GPIO_PIN_0},  FMKCDA_ADC_1, FMKCDA_ADC_1_CHANNEL_10},  // FMKIO_INPUT_SIGANA_2
        {{FMKIO_GPIO_PORT_C            , FMKIO_GPIO_PIN_0},  FMKCDA_ADC_1, FMKCDA_ADC_1_CHANNEL_10},  // FMKIO_INPUT_SIGANA_4
        {{FMKIO_GPIO_PORT_C            , FMKIO_GPIO_PIN_0},  FMKCDA_ADC_1, FMKCDA_ADC_1_CHANNEL_10},  // FMKIO_INPUT_SIGANA_5
        {{FMKIO_GPIO_PORT_C            , FMKIO_GPIO_PIN_0},  FMKCDA_ADC_1, FMKCDA_ADC_1_CHANNEL_10},  // FMKIO_INPUT_SIGANA_6
        {{FMKIO_GPIO_PORT_C            , FMKIO_GPIO_PIN_0},  FMKCDA_ADC_1, FMKCDA_ADC_1_CHANNEL_10},  // FMKIO_INPUT_SIGANA_7
        {{FMKIO_GPIO_PORT_C            , FMKIO_GPIO_PIN_0},  FMKCDA_ADC_1, FMKCDA_ADC_1_CHANNEL_10},  // FMKIO_INPUT_SIGANA_8
        {{FMKIO_GPIO_PORT_C            , FMKIO_GPIO_PIN_0},  FMKCDA_ADC_1, FMKCDA_ADC_1_CHANNEL_10},  // FMKIO_INPUT_SIGANA_9
        {{FMKIO_GPIO_PORT_C            , FMKIO_GPIO_PIN_0},  FMKCDA_ADC_1, FMKCDA_ADC_1_CHANNEL_10},  // FMKIO_INPUT_SIGANA_10
    };
    // Flag automatic generate code 
    ...
    const t_sFMKIO_BspEvntSigCfg c_InEvntSigBspMap_as[FMKIO_INPUT_SIGEVNT_NB] = {
        {{FMKIO_GPIO_PORT_A            , FMKIO_GPIO_PIN_0},     EXTI0_1_IRQn},
        {{FMKIO_GPIO_PORT_A            , FMKIO_GPIO_PIN_0},     EXTI2_3_IRQn},
